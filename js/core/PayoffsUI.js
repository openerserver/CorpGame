function PayoffsUI(config){
	...
	// Labels
	dom.appendChild(_makeLabel("label_cooperate", {x:208, y:0, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cooperate", {x:62, y:0, rotation:-45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cheat", {x:275, y:60, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cheat", {x:6, y:60, rotation:-45, align:"center", color:"#cccccc"}));
