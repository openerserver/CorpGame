Tournament.resetGlobalVariables = function(max_num){

	Tournament.SELECTION = 5;
	Tournament.NUM_TURNS = 10;
	var ss=parseInt(max_num/8);
	Tournament.INITIAL_AGENTS = [
		{strategy:"tft", count:ss},
		{strategy:"all_d", count:ss},
		{strategy:"all_c", count:ss},
		{strategy:"grudge", count:ss},
		{strategy:"prober", count:ss},
		{strategy:"tf2t", count:ss},
		{strategy:"pavlov", count:ss},
		{strategy:"random", count:max_num-ss*7}
...
subscribe("rules/max_num",function(value){
	...
	Tournament.INITIAL_AGENTS = [
		...
		{strategy:"tf2t", count:ss},
		{strategy:"pavlov", count:ss},
		{strategy:"random", count:value-ss*7}
		//{strategy:"random2", count:4}
	];
	publish("sandbox/pop/tft", [ss]);
	publish("sandbox/pop/all_d", [ss]);
	publish("sandbox/pop/all_c", [ss]);
	publish("sandbox/pop/grudge", [ss]);
	publish("sandbox/pop/prober", [ss]);
	publish("sandbox/pop/tf2t", [ss]);
	publish("sandbox/pop/pavlov", [ss]);
	publish("sandbox/pop/random", [value-ss*7]);
