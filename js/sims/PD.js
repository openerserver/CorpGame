...
function Logic_tft(){ // 复读机，每次都是对方的最后一次行为
	var self = this;
...
function Logic_grudge(){ //如果曾经欺骗自己，就总是欺骗对方
	var self = this;
